...
const AddWorkerFormOneAdmin = () => {
  ...
  const roles = ["1", "2", "3", "4", "5"]; // Example role options
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-6">
                      ...
                      <div className="mb-3">
                        ...
                        {/* <select className="form-select" id="exampleFormControlSelect1" name="SelectFeilds" onChange={handleChange} value={formData.SelectFeilds}>
                          <option>1</option>
                          <option>2</option>
                          <option>3</option>
                          <option>4</option>
                        ...
                        {roles.map((role) => (
                          <div key={role} className="checkbox-item">
                            <input
                              ...
                              name="SelectFeilds" onChange={handleChange} value={formData.SelectFeilds}
                            />
                        ...
                        <p>Selected Feilds: {selectedRoles.join(", ")}</p>
                        <style>
                        {`
                        .checkbox-container {
                        display: grid;
  ...
  {roles.map((role) => (
    <div key={role} className="checkbox-item">
      <input
        ...
        value={role}
        checked={
          Array.isArray(formData.SelectFeilds) &&
          formData.SelectFeilds.includes(role)
        }
        onChange={() => handleCheckboxChange(role)}
      />
      <label className="form-check-label" htmlFor={`role-${role}`}>
